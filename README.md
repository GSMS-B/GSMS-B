# 👋 Hi there, I'm Ganasyam Mani Sankar Bugatha!

**Computer Science Student at JNTU-GV CEV** 🎓 | Building intelligent systems that solve real problems
...
This approach enables me to ship production-ready products in days, not months.
...
### **AI & Machine Learning**
LLMs (Google Gemini) | LangChain | Multi-Agent Systems | RAG (Retrieval-Augmented Generation) | ChromaDB | Sentence Transformers | NLP | Sentiment Analysis | Hugging Face (Transformers, Datasets, Spaces)

### **Backend Development**
FastAPI | SQLAlchemy (Async) | RESTful APIs | PostgreSQL | JWT Authentication | Bcrypt | API Integration | Error Handling & Logging | Connection Pooling (pgbouncer)

### **Frontend Development**
HTML/CSS | Vanilla JavaScript | Responsive Web Design | DOM Manipulation | Chart.js | Data Visualization

### **Cloud & Deployment**
Render | Supabase | Hugging Face Spaces | Database Management | Git/GitHub | Cloud Deployment

### **Finance & Trading**
NewsAPI | Financial Data APIs (BSE/NSE) | Portfolio Optimization | Modern Portfolio Theory | Sharpe Ratio Analysis | Risk-Return Analysis | Contrarian Investing | Technical & Fundamental Analysis | Quantitative Finance

### **Tools & Workflows**
Vibe Coding Tools | Anthropic's Claude | GitHub Copilot | Cursor | V0 | Bolt | Stitch AI | Antigravity | AI-Assisted Development | Rapid Prototyping | Agile Development | QR Code Generation | Geolocation Services (GeoLite2, ip-api.com) | Real-time Analytics | Async Programming
...
I'm diving deeper into **AI systems, Agentic AI, and advanced RAG architectures**—exploring how autonomous agents can solve complex problems. I'm also passionate about applying these AI techniques to **financial technology** and building products across different domains—**real-time analytics, privacy tech, and developer tools**.

Building real products that solve real problems—that's what drives me.

**Let's connect if you're interested in AI, agentic systems, finance, or building something impactful together.** 🚀

---

📧 bugathaganasyammanisankar@gmail.com | 💼 [LinkedIn](https://www.linkedin.com/in/ganasyam-mani-sankar-bugatha-935120303) | 💻 [GitHub](https://github.com/GSMS-B/)
